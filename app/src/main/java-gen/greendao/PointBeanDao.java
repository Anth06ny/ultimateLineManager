...
public class PointBeanDao extends AbstractDao<PointBean, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Stop = new Property(3, java.util.Date.class, "stop", false, "STOP");
        public final static Property Length = new Property(4, long.class, "length", false, "LENGTH");
        public final static Property PauseTime = new Property(5, java.util.Date.class, "pauseTime", false, "PAUSE_TIME");
        public final static Property Pause = new Property(6, Boolean.class, "pause", false, "PAUSE");
        public final static Property TeamOffense = new Property(7, Boolean.class, "teamOffense", false, "TEAM_OFFENSE");
        public final static Property TeamGoal = new Property(8, Boolean.class, "teamGoal", false, "TEAM_GOAL");
        public final static Property MatchId = new Property(9, long.class, "matchId", false, "MATCH_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'POINT_BEAN' (" + //
                ...
                "'PAUSE' INTEGER," + // 6: pause
                "'TEAM_OFFENSE' INTEGER," + // 7: teamOffense
                "'TEAM_GOAL' INTEGER," + // 8: teamGoal
                "'MATCH_ID' INTEGER NOT NULL );"); // 9: matchId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, PointBean entity) {
        ...
        if (stop != null) {
            stmt.bindLong(4, stop.getTime());
        }
        stmt.bindLong(5, entity.getLength());
 
        java.util.Date pauseTime = entity.getPauseTime();
        if (pauseTime != null) {
            stmt.bindLong(6, pauseTime.getTime());
        }
 
        Boolean pause = entity.getPause();
        if (pause != null) {
            stmt.bindLong(7, pause ? 1l: 0l);
        }
 
        Boolean teamOffense = entity.getTeamOffense();
        if (teamOffense != null) {
            stmt.bindLong(8, teamOffense ? 1l: 0l);
        }
 
        Boolean teamGoal = entity.getTeamGoal();
        if (teamGoal != null) {
            stmt.bindLong(9, teamGoal ? 1l: 0l);
        }
        stmt.bindLong(10, entity.getMatchId());
    }
    ...
    public PointBean readEntity(Cursor cursor, int offset) {
        PointBean entity = new PointBean( //
            ...
            cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)), // stop
            cursor.getLong(offset + 4), // length
            cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)), // pauseTime
            cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6) != 0, // pause
            cursor.isNull(offset + 7) ? null : cursor.getShort(offset + 7) != 0, // teamOffense
            cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0, // teamGoal
            cursor.getLong(offset + 9) // matchId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PointBean entity, int offset) {
        ...
        entity.setStop(cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)));
        entity.setLength(cursor.getLong(offset + 4));
        entity.setPauseTime(cursor.isNull(offset + 5) ? null : new java.util.Date(cursor.getLong(offset + 5)));
        entity.setPause(cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6) != 0);
        entity.setTeamOffense(cursor.isNull(offset + 7) ? null : cursor.getShort(offset + 7) != 0);
        entity.setTeamGoal(cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0);
        entity.setMatchId(cursor.getLong(offset + 9));
     }
