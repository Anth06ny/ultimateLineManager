...
/** 
 * DAO for table TEAM_BEAN.
*/
public class TeamBeanDao extends AbstractDao<TeamBean, Long> {

    public static final String TABLENAME = "TEAM_BEAN";

    /**
     * Properties of entity TeamBean.<br/>
    ...
    */
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TEAM_BEAN'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TeamBean entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TeamBean readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TeamBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TeamBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
